package com.view.PeopleView.ChildPeople
{
   ...
   public class birthdayAvatar extends simplePeople
   {
      
      public function birthdayAvatar()
      {
         super();
         offset = 8;
      }
      ...
      override public function initAvatar() : void
      {
         ...
         trace("加載生日套裝",InstanceMC.address);
         GC.clearAllChildren(avatarMC.Visualize_mc);
         isActionMovie = true;
         InstanceMC.isActionMovie = true;
         var tempAvatar:Class = UIManager.getClass("body_" + InstanceMC.address);
