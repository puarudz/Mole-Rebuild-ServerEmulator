package com.view.FightWorld
{
   ...
   public class UIFightWorld
   {
      ...
      {
         var req:URLRequest = new URLRequest(Links.getUrl("resource/ui/FightWorldUI.swf"));
      ...
      private function onComplete(event:Event) : void
      {
         ...
         GV.onlineSocket.dispatchEvent(new Event("fightComplete"));
      }
