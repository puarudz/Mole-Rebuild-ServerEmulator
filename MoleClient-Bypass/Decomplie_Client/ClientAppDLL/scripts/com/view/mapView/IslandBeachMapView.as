package com.view.mapView
{
   ...
   public class IslandBeachMapView extends MapBase
   {
      ...
      public function IslandBeachMapView()
      {
         super();
      }
      ...
      override protected function initView() : void
      {
         ...
         tip.tipTailDisPlayObject(this.target_mc.openGame_btn,"挑戰便便樹");
      ...
      {
         AngelsAndDemonsCtl.instance.LoadBeginPanelFun(AngelsAndDemonsCtl.begin_url,2);
      }
