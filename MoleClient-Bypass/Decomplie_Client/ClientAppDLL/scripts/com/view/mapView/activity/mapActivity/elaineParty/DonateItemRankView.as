package com.view.mapView.activity.mapActivity.elaineParty
{
   ...
   public class DonateItemRankView extends BasePartyView
   {
      ...
      public function DonateItemRankView(ui:MovieClip)
      {
         super(ui);
      ...
      override protected function Init() : void
      {
         ...
         ElainePartySocket.CheckCharityDonateRanking(ElainePartySocket.Rank_Type_DonateItem);
      }
