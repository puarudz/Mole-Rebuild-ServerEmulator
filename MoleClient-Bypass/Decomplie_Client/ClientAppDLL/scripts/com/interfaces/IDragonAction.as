package com.interfaces
{
   ...
   public interface IDragonAction
   {
      
      function get dragonBody() : Sprite;
      
      function set dragonInfo(param1:DragonInfo) : void;
      
      function get dragonInfo() : DragonInfo;
      
      function set speed(param1:int) : void;
      
      function get speed() : int;
      
      function driveDragon(param1:MovieClip, param2:MovieClip) : void;
