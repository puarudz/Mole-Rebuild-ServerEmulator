package com.common.Alert.childAlert
{
   ...
   public class icoAlert2 extends simpleAlert
   {
      ...
      public function icoAlert2(obj:*, title:String = "提示", content:String = "...", style:uint = 0, bottomArray:String = "A", closeB:Boolean = true)
      {
      ...
      override public function showAlert() : void
      {
         ...
         if(this.myButtonArray == "EMP")
         {
            ...
            myAlert.drag_mc.width = 400;
            myAlert.drag_mc.height = 300;
         ...
         else
         {
            ...
            this.contentText = myAlert.content_txt;
            this.titleText = myAlert.title_txt;
            dispatchObj.addChild(myAlert);
      ...
      public function getContentText() : TextField
      {
