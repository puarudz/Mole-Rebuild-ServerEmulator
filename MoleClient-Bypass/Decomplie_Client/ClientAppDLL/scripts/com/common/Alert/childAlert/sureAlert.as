package com.common.Alert.childAlert
{
   ...
   public class sureAlert extends simpleAlert
   {
      
      public function sureAlert(obj:*, title:String = "提示", content:String = "...", style:uint = 0, bottomArray:String = "A", closeB:Boolean = true)
      {
