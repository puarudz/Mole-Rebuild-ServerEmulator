package com.common.util
{
   ...
   public class StringUtil
   {
      ...
      public static function renewZero(str:String, len:int, limit:String = "0") : String
      {
         var i:int = 0;
         var bul:String = "";
      ...
      public static function newZeroBack(str:String, len:int, limit:String = "0") : String
      {
         var i:int = 0;
         var bul:String = "";
         var strLen:int = str.length;
      ...
      public static function FillString(str:String, maxLen:int) : ByteArray
      {
         var len:int = 0;
         var i:int = 0;
         ...
         newByte.writeUTFBytes(byte.readUTFBytes(maxLen));
         return newByte;
      }
   }
}
