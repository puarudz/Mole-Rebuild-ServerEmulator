package com.common.view.MCScrollBar
{
   ...
   public class MCScrollBarPresent extends MovieClip
   {
      ...
      public function MCScrollBarPresent(scrollBarMC:*, targetMC:*, target_width:Number, target_height:Number)
      {
         super();
         GV.onlineSocket.addEventListener("Present_Manager_Event",this.removeHandler);
      ...
      public function moveDragMC(evt:TimerEvent) : void
      {
         var dir:int = this.isAction ? -1 : 1;
      ...
      public function removeHandler(evt:EventTaomee = null) : void
      {
         this.dragTimer.stop();
         GV.onlineSocket.removeEventListener("Present_Manager_Event",this.removeHandler);
         ...
         MainManager.getStage().removeEventListener(MouseEvent.MOUSE_UP,this.upDragHandler);
