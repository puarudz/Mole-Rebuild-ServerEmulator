package com.common.view.MCScrollBar
{
   ...
   public class MCScrollBar extends MovieClip
   {
      ...
      public function MCScrollBar(scrollBarMC:*, targetMC:*, target_width:Number, target_height:Number)
      {
         super();
         GV.onlineSocket.addEventListener("friendEvent",this.removeHandler);
      ...
      {
         this.dragTimer.stop();
         GV.onlineSocket.removeEventListener("friendEvent",this.removeHandler);
