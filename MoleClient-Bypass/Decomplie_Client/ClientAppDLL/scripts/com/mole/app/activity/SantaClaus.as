package com.mole.app.activity
{
   ...
   public class SantaClaus
   {
      ...
      private static var instance:SantaClaus;
      ...
      public static function getInstance() : SantaClaus
      {
         if(!instance)
         {
      ...
      private static function get isStartMap() : Boolean
      {
         ...
         if(curDate.hours == 18)
         {
            ...
            if(MapManager.curMapID == 68)
            {
               return curDate.minutes >= 20 && curDate.minutes < 40;
            }
            if(MapManager.curMapID == 6)
            {
         ...
         {
            if(MapManager.curMapID == 204)
            {
               return curDate.minutes >= 0 && curDate.minutes < 20;
            }
            if(MapManager.curMapID == 77)
            {
               return curDate.minutes >= 20 && curDate.minutes < 40;
            }
            if(MapManager.curMapID == 9)
            {
               return curDate.minutes >= 40 && curDate.minutes < 60;
            }
         }
      ...
      public function setup() : void
      {
         ...
         var curDate:Date = ServerUpTime.getInstance().chinaDate;
         if(isStartDate && (MapManager.curMapID == 1 || MapManager.curMapID == 68 || MapManager.curMapID == 6 || MapManager.curMapID == 204 || MapManager.curMapID == 77 || MapManager.curMapID == 9))
         {
      ...
      private function onCheckTime(delay:Number) : void
      {
         ...
         if((curDate.minutes == 0 || curDate.minutes == 20 || curDate.minutes == 40) && (curDate.hours == 18 || curDate.hours == 19) && curDate.date == 31)
         {
         ...
         isChange = false;
         tmpCount = Math.floor(curDate.minutes / 20);
         tmpMinutes = curDate.minutes % 20;
         shardCount = uint(MoleSharedObject.moleObj.SantaClausCount);
         if(isStartMap && MoleSharedObject.moleObj.SantaClausCount != tmpCount)
         {
            _count = tmpCount;
            shardCount++;
            ...
            _fireMovie = PlayMovie.play("resource/newTask/activity/act20121212.swf",null,null,function():void
            {
               ...
               MoleSharedObject.moleObj.SantaClausCount = tmpCount;
            },null,null,false);
         }
         ...
         if((tmpMinutes == 0 || tmpMinutes == 20 || tmpMinutes == 40) && curDate.seconds == 0 && (curDate.hours == 18 || curDate.hours == 19) && curDate.date == 31)
         {
