package com.mole.app.task.action
{
   ...
   public class TaskJumpLoveAction extends TaskActionBase
   {
      
      private var _panel:AppModuleControl;
      
      public function TaskJumpLoveAction(actionXml:XML, parent:TaskTriggerBase)
      {
      ...
      {
         this._panel = ModuleManager.openPanel(ModuleType.TASK_JUMP_LOVE_PANEL,_param);
