package com.logic.socket
{
   ...
   public class GetLimitStatus extends SocketProtocol
   {
      ...
      {
         super(CommandID.cli_proto_get_limit_info);
      }
      ...
      public static function send(arr:Array) : void
      {
         ...
         if(arr.length > 0)
         {
            ...
            GF.sendSocket(CommandID.cli_proto_get_limit_info,data);
         }
      }
