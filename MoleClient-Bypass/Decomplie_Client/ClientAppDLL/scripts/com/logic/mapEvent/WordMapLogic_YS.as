package com.logic.mapEvent
{
   ...
   public class WordMapLogic_YS extends Sprite
   {
      ...
      public function WordMapLogic_YS(map:*)
      {
         super();
      ...
      private function loadXML() : void
      {
         ...
         this.worldXML = XMLInfo.WorldMapXML_YS;
      ...
      private function initMolePlace() : void
      {
         ...
         if(placeNul > 1000 || placeNul == 82 || placeNul == 58)
         {
            ...
            {
               if(Boolean(mapMC) && Boolean(mapMC.map_btn) && Boolean(mapMC.map_btn["btn_365"]))
               {
                  mapMC.mole_mc.x = mapMC.map_btn["btn_365"].x + mapMC.map_btn.x;
                  mapMC.mole_mc.y = mapMC.map_btn["btn_365"].y + mapMC.map_btn.y;
               }
            }
         ...
         {
            mapMC.mole_mc.visible = true;
            mapMC.mole_mc.x = mapMC.map_btn["btn_" + 365].x + mapMC.map_btn.x;
            mapMC.mole_mc.y = mapMC.map_btn["btn_" + 365].y + mapMC.map_btn.y;
         }
