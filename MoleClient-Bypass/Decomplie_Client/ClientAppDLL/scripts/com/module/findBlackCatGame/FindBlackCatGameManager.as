package com.module.findBlackCatGame
{
   ...
   public class FindBlackCatGameManager extends Sprite
   {
      
      public var MyLoader:*;
      
      public function FindBlackCatGameManager(mc:*, obj:Object = null)
      {
         super();
         this.MyLoader = mc;
         new ClientGameSerSocket(obj.ip,obj.port,obj.SessionID);
         GV.onlineSocket.dispatchEvent(new Event("findCatGameSeverReady"));
      ...
      private function ServerConnect(E:*) : void
      {
         ...
         BC.addEvent(this,GV.onlineSocket,"CLOSE_FIND_CAT_GAME",this.closeFunc);
      }
      
      private function readyGame(e:* = null) : void
      {
         GV.onlineSocket.dispatchEvent(new EventTaomee("getFindCatPeopleArray",e.EventObj));
      }
      ...
      public function closeFunc(E:* = null) : void
      {
         ...
         BC.removeEvent(this,GV.onlineSocket,"CLOSE_FIND_CAT_GAME",this.closeFunc);
