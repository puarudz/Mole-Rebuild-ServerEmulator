package com.module.monoplayGame
{
   ...
   public class MonoPlayGameManage extends Sprite
   {
      
      private static var inst:MonoPlayGameManage;
      
      public var MyLoader:*;
      
      public function MonoPlayGameManage()
      {
         super();
      }
      
      public static function getInstance() : MonoPlayGameManage
      {
         if(!inst)
         {
            inst = new MonoPlayGameManage();
         }
         return inst;
      }
      ...
      public function initserver(mc:*, obj:Object = null) : void
      {
         this.MyLoader = mc;
         new ClientGameSerSocket(obj.ip,obj.port,obj.SessionID);
         GV.onlineSocket.dispatchEvent(new Event("GameSeverReady_monoplay"));
         ...
         BC.removeEvent(this,GV.onlineSocket,"CLOSE_MONOPLAY_GAME",this.closeFunc);
      ...
      private function ServerConnect(E:*) : void
      {
         ...
         BC.addEvent(this,GV.onlineSocket,"CLOSE_MONOPLAY_GAME",this.closeFunc);
      }
      ...
      {
         GV.onlineSocket.dispatchEvent(new Event("MonoPlayClose"));
      }
