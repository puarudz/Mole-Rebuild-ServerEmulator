package com.module.classroom
{
   ...
   import com.module.classroom.special.ClassSpecialGoods;
   import com.module.home.special.HomeSpecialGoods;
   import com.module.newHouse.GoodsLogic;
   ...
   public class ClassEditView extends MovieClip
   {
      
      private static var instance:ClassEditView;
      ...
      public function ClassEditView()
      {
         super();
      }
      
      public static function getInstance() : ClassEditView
      {
         if(instance == null)
         {
            instance = new ClassEditView();
         }
         return instance;
      }
      
      public function setValue(obj:Object, root:Object) : void
      {
         this.RootMC = root;
         this.HomeObj = obj;
      ...
      public function loadGoods(temp:Object) : void
      {
         ...
         tempLoader.load(VL.getURLRequest("resource/classroom/swf/" + temp.ID + ".swf"));
         if(temp.Layer == 1)
         {
      ...
      public function completeHandler(e:Event) : void
      {
         ...
         ClassSpecialGoods.specialgood(goodsMC);
      ...
      public function startdrag(e:Event) : void
      {
         ...
         if(Editable)
         {
            ...
            if(Boolean(this.actionGoods.moving))
            {
               ...
               this.oldIndex = this.parentMC.getChildIndex(this.movingMC as DisplayObject);
               this.index = this.movingMC.num;
               topPosition = this.parentMC.numChildren - 1;
               this.parentMC.setChildIndex(this.movingMC as DisplayObject,topPosition);
               ...
               classHitTest.hitTesting(this.actionGoods,this.movingMC);
            }
            else
            {
               trace("===============stopHitTesting");
      ...
      private function doAction() : void
      {
         ...
         if(classHitTest.backOldPos)
         {
            ...
            this.parentMC.setChildIndex(this.movingMC as DisplayObject,this.oldIndex);
         }
         else
         {
            this.levelCtrl();
         }
         if(classHitTest.backDepot)
         {
      ...
      private function removeGoods(mc:Object) : void
      {
         var ld:Object = null;
         if(mc.Layer == 1)
         {
      ...
      private function getarry(parentMC:MovieClip) : void
      {
      ...
      private function sort(parentMC:Object, arr:Array) : void
      {
         var j:int = 0;
         ...
         if(arguments[0].numChildren > 0)
         {
            if(arguments[0].getChildAt(0) is MovieClip)
            {
               if(arguments[0].getChildAt(0).totalFrames != 1)
               {
                  ...
                  mc = arguments[0].getChildAt(0) as MovieClip;
      ...
      public function isAllGoodsLoaded() : void
      {
         ...
         {
            ++this.loadNum;
            if(this.loadNum == this.homeItemArr.length - 1)
            {
               this.loadNum = 0;
               this.loadComplete = true;
