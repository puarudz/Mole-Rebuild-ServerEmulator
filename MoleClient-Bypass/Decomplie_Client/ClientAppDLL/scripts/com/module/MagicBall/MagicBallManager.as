package com.module.MagicBall
{
   ...
   public class MagicBallManager extends Sprite
   {
      
      private static var inst:MagicBallManager;
      
      public var MyLoader:*;
      
      public function MagicBallManager()
      {
         super();
      }
      ...
      public function initserver(mc:*, obj:Object = null) : void
      {
         ...
         GV.onlineSocket.dispatchEvent(new Event("GameSeverReady_magicBall"));
         ...
         BC.removeEvent(this,GV.onlineSocket,"CLOSE_MAGICBALL_GAME",this.closeFunc);
      ...
      private function ServerConnect(E:*) : void
      {
         ...
         BC.addEvent(this,GV.onlineSocket,"CLOSE_MAGICBALL_GAME",this.closeFunc);
      }
      ...
      {
         GV.onlineSocket.dispatchEvent(new Event("MagicBallClose"));
      }
