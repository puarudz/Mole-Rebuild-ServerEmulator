package com.module.home
{
   ...
   public class HomeLogic extends EventDispatcher
   {
      
      private static var instance:HomeLogic;
      
      public static var GET_DEPOT_GOODS:String = "GET_DEPOT_GOODS";
      ...
      public static function getInstance() : HomeLogic
      {
         if(instance == null)
         {
      ...
      public function get homeBGID() : uint
      {
         return HomeEditView.getInstance().homeItemArr[0].ID;
      }
      
      public function HomeDepotReq() : void
      {
         GV.onlineSocket.addEventListener(GetHomeInfoRes.GET_HOME_DEPOT_INFO,this.getHomeDepot);
         GetHomeInfoReq.getHomeDepotInfo();
      }
      ...
      public function sortGoods() : void
      {
         ...
         dispatchEvent(new EventTaomee(GET_DEPOT_GOODS,{"arr":this.sortArr}));
      }
