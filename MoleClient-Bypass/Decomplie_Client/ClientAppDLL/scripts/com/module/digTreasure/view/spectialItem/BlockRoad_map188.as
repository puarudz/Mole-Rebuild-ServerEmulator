package com.module.digTreasure.view.spectialItem
{
   ...
   public class BlockRoad_map188 implements IDigTreasureSpecialCtl
   {
      ...
      public function BlockRoad_map188()
      {
         super();
      }
      ...
      private function onEntreFrameHandler(e:Event) : void
      {
         ...
         {
            this._mole.moveTo(this._boss.canWalkX,this._boss.canWalkY);
