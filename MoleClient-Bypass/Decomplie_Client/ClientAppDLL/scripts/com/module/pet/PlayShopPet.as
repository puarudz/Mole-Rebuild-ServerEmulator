package com.module.pet
{
   ...
   public class PlayShopPet
   {
      ...
      public function PlayShopPet(mc:MovieClip)
      {
         super();
         this.target_mc = mc;
      ...
      public function playpet1(e:MouseEvent) : void
      {
      ...
      public function playpet2(e:MouseEvent) : void
      {
         if(GV.MyInfo_PetObj.Level > 1)
         {
            if(Boolean(this.playpet))
            ...
            this.playpet = this.target_mc.playlahmMC.lahm2;
            this.lahmRun();
         }
      }
      ...
      private function stopPlayPet() : void
      {
         if(Boolean(this.playpet))
         {
            ...
            this.target_mc.playlahmMC.zhuangquan.gotoAndStop(1);
            this.target_mc.playlahmMC.zhuangquan1.gotoAndStop(1);
         }
      }
      ...
      private function lahmRun() : void
      {
         ...
         {
            this.target_mc.playlahmMC.zhuangquan.play();
            this.target_mc.playlahmMC.zhuangquan1.play();
         }
