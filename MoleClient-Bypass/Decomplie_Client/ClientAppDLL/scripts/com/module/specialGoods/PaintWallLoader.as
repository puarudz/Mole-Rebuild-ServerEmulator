package com.module.specialGoods
{
   ...
   public class PaintWallLoader
   {
      
      private var mcloader:MCLoader;
      
      public function PaintWallLoader()
      {
         super();
         this.init();
      }
      ...
      {
         this.mcloader = new MCLoader("module/external/PaintWall.swf",MainManager.getGameLevel(),1,"正在打開塗鴉牆...");
