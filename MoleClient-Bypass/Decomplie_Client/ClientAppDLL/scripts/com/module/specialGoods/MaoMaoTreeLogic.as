package com.module.specialGoods
{
   ...
   public class MaoMaoTreeLogic
   {
      
      private var mcloader:MCLoader;
      
      public function MaoMaoTreeLogic()
      {
         super();
         this.init();
      }
      ...
      {
         this.mcloader = new MCLoader("module/external/MaoMaoTree.swf?v=090807",MainManager.getGameLevel(),1,"正在打開毛毛樹面板...");
