package com.module.specialGoods
{
   ...
   public class FootPrintsLogic
   {
      
      private var mcloader:MCLoader;
      
      public function FootPrintsLogic()
      {
         super();
         this.init();
      }
      ...
      {
         this.mcloader = new MCLoader("module/external/FootPrints.swf",MainManager.getGameLevel(),1,"正在打開腳印...");
