package com.module.specialGoods
{
   ...
   public class TuyaReplayLogic
   {
      
      private var mcloader:MCLoader;
      
      public function TuyaReplayLogic()
      {
         super();
         this.init();
      }
      ...
      {
         this.mcloader = new MCLoader("module/external/PaintReplay.swf",MainManager.getGameLevel(),1,"正在打開我的畫板...");
