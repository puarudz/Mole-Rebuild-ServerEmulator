package com.module.specialGoods
{
   ...
   public class SpecialGoodsLoader
   {
      ...
      public function SpecialGoodsLoader(obj:Object)
      {
         super();
         this.Obj = obj;
         this.init();
      ...
      {
         this.mcloader = new MCLoader(this.Obj.swf,MainManager.getAppLevel(),1,this.Obj.tip);
